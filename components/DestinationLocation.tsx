  ...
  return (
    <div className='grid grid-cols-3 gap-5'>
      {category.map((item: Category) => (
        <Link href={`/destination/${item.id}`} className='group duration-300 shadow-[0_5px_10px_0px] shadow-[#9a9a9a] relative max-w-[400px] w-full h-[120px] rounded-[15px] overflow-hidden' key={item.id}>
